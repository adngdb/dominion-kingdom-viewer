/*
	Credit for this file goes to Michael Ressler (mressler),
	see https://github.com/mressler/RanDominion/blob/master/dominionCards.js
	Thanks Michael!

	I removed a bunch of things I don't use, and added a few missing cards:
	* Stash
	* Bag of Gold
	* Diadem
	* Followers
...
var cards = [
	...
	},
	{
		...
		isAction : true,
		cost : 0,
		description : "Gain a Gold, putting it on top of your deck. (This is not in the Supply.)"
	},
	{
		name : "Diadem",
		setId : 7,
		isTreasure : true,
		cost : 0,
		description : "When you play this, +1 Coin per unused Action you have (Action, not Action card). (This is not in the Supply.)"
	},
	{
		name : "Fairgrounds",
		setId : 7,
	...
	},
	{
		...
		isAction : true,
		cost : 0,
		description : "Gain an Estate. Each other player gains a Curse and discards down to 3 cards in hand. (This is not in the Supply.)",
	},
	{
		name : "Fortune Teller",
		setId : 7,
	...
	},
	{
		...
		cost : 0,
		buys : 1,
		description : "While this is in play, cards cost 2 Coins less, but not less than 0 Coins. (This is not in the Supply.)",
	},
	{
		name : "Remake",
		setId : 7,
...
for (var i in cards) {
	cardLookupByName[cards[i].name.toLowerCase()] = i;
}
